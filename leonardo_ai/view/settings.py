...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.grpClientGQL.sizePolicy().hasHeightForWidth())
        self.grpClientGQL.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.grpClientRest.sizePolicy().hasHeightForWidth())
        self.grpClientRest.setSizePolicy(sizePolicy)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.chkNSFW)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.chkPublic)
        self.frmFiller = QtWidgets.QFrame(Settings)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.frmFiller)
        self.btnClose = QtWidgets.QPushButton(Settings)
        self.btnClose.setObjectName("btnClose")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.btnClose)
        self.btnApply = QtWidgets.QPushButton(Settings)
        self.btnApply.setObjectName("btnApply")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.btnApply)
        ...
        self.inCacheDir = QtWidgets.QLineEdit(self.frame_2)
        self.inCacheDir.setEnabled(True)
        self.inCacheDir.setReadOnly(True)
        self.inCacheDir.setObjectName("inCacheDir")
        self.horizontalLayout_2.addWidget(self.inCacheDir)
        self.btnCacheDir = QtWidgets.QToolButton(self.frame_2)
        icon = QtGui.QIcon.fromTheme("folder-open")
        self.btnCacheDir.setIcon(icon)
        self.btnCacheDir.setObjectName("btnCacheDir")
        self.horizontalLayout_2.addWidget(self.btnCacheDir)
    ...
    def retranslateUi(self, Settings):
        ...
        Settings.setWindowTitle(_translate("Settings", "Leonardo AI - Settings"))
        ...
        self.label_7.setText(_translate("Settings", "Cache"))
        self.inCacheDir.setPlaceholderText(_translate("Settings", "/path/to/cache"))
        self.btnCacheDir.setText(_translate("Settings", "..."))
